...
import { Laptop, ShieldCheck, Smartphone, Trash2, type LucideIcon } from "lucide-react";
import type { AccountSession } from "@/types/traveler";
...
/** Device form factor → icon. Keeps icons out of the (serialisable) service data. */
const KIND_ICON: Record<AccountSession["kind"], LucideIcon> = {
  desktop: Laptop,
  mobile: Smartphone,
};

export function SecurityView({ initialSessions }: { initialSessions: AccountSession[] }) {
