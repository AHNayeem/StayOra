...
export const MESSAGE_TEMPLATES: MessageTemplate[] = [
  ...
  },
  {
    ...
    category: "payment",
    channels: ["email", "push", "inapp"],
    subject: "{{organiser}} asked you to pay {{amount}} for {{product}}",
    body: "Hi {{name}}, {{organiser}} has booked {{product}} ({{reference}}) and split the {{total}} between everyone travelling.\n\nYour share is {{amount}}. Settle it within {{hours}} hours or {{organiser}} will be asked to cover it.",
    short: "{{organiser}} asked you to pay {{amount}} for {{product}}.",
  },
  {
    key: "split_complete",
    name: "Split settled in full",
    category: "payment",
    channels: ["email", "inapp"],
    subject: "{{product}} is paid in full",
    body: "Hi {{name}}, all {{people}} shares for {{product}} ({{reference}}) have been paid — {{total}} in total. Nothing else is owed.",
    short: "{{product}} is paid in full — {{total}} across {{people}} people.",
  },
  {
    key: "split_expired",
    name: "Split window closed",
    category: "payment",
    channels: ["email", "push", "inapp"],
    subject: "{{amount}} is still outstanding on {{product}}",
    body: "Hi {{name}}, the window for everyone to pay their share of {{product}} ({{reference}}) has closed and {{amount}} is still outstanding.\n\nYour booking is safe — cover the balance yourself, or chase the people who haven't paid.",
    short: "{{amount}} still owed on {{product}}. Cover it or send another reminder.",
  },
  {
    ...
    category: "payment",
    channels: ["email", "inapp"],
    subject: "Your {{plan}} membership has renewed",
    body: "Hi {{name}}, we've renewed your {{plan}} membership for {{amount}}. Your benefits run to {{until}}.\n\nYou can change or cancel it any time from your account.",
    short: "{{plan}} renewed — {{amount}}, through {{until}}.",
  },
  {
    key: "membership_payment_failed",
    name: "Membership charge declined",
    category: "payment",
    channels: ["email", "push", "inapp"],
    subject: "We couldn't renew your {{plan}} membership",
    body: "Hi {{name}}, the {{amount}} charge for your {{plan}} membership was declined: {{reason}}\n\nThat was attempt {{attempt}} of {{of}} — we'll try again in {{retry}}. Update your card to keep your benefits without a break.",
    short: "{{plan}} renewal declined ({{attempt}}/{{of}}). Update your card.",
  },
  {
    ...
    category: "payment",
    channels: ["email", "inapp"],
    subject: "Your {{plan}} membership has ended",
    body: "Hi {{name}}, we tried {{of}} times to charge {{amount}} for your {{plan}} membership and couldn't: {{reason}}\n\nYour benefits have stopped. Resubscribe whenever you're ready — nothing else has changed on your account.",
    short: "{{plan}} membership ended after {{of}} declined charges.",
  },
  {
    key: "price_alert",
    name: "Price alert",
    category: "marketing",
    channels: ["email", "push", "inapp"],
    subject: "{{search}} is now {{price}}",
    body: "Hi {{name}}, the search you're watching — {{search}} — has come down to {{price}}, {{drop}} below where it was and at or under your {{target}} target.\n\n{{product}} is the cheapest match right now. Prices move, so book while it holds.",
    short: "{{search}} is now {{price}} — under your {{target}} target.",
  },
  {
